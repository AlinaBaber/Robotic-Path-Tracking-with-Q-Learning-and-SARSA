...
import time  # Time is needed to slow down the agent and to see pip install pillow he runs
...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('Robotic Path Tracking by Q Learning')
    ...
    def build_environment(self):
        ...
        img_obstacle4 = img_obstacle4.resize((40, 40), Image.NEAREST)
        ...
        img_obstacle5 = img_obstacle5.resize((40, 40), Image.NEAREST)
        ...
        img_obstacle6 = img_obstacle6.resize((40, 40), Image.NEAREST)
        ...
        img_obstacle7 = img_obstacle7.resize((40, 40), Image.NEAREST)
        ...
        img_obstacle8 = img_obstacle8.resize((40, 40), Image.NEAREST)
        ...
        img_flag  = img_flag.resize((40, 40), Image.NEAREST)
        ...
        img_robot = img_robot.resize((40, 40), Image.NEAREST)
